      ...
      <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div aria-live="polite">
          ...
          {data && <div className="space-y-4">
            <div className="rounded-xl border border-border bg-card p-5"><p className="text-xs font-semibold text-accent">{data.provider === 'openai' ? 'OPENAI' : 'GEMINI'} 最終判斷</p><h2 className="mt-3 text-xl font-semibold leading-7">{data.result.best_spec}</h2><p className="mt-3 text-sm leading-6 text-muted-foreground">{data.result.conclusion}</p></div>
